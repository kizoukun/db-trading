                                ...
                                <div class="mt-5">
                                    <div class="rounded-md bg-gray-50 px-6 py-5 sm:flex sm:items-start sm:justify-between">
                                        ...
                                        <div class="sm:flex sm:items-start">
                                            <svg class="h-8 w-auto sm:h-6 sm:flex-shrink-0" viewBox="0 0 36 24"
                                                aria-hidden="true">
                                    ...
                                    <div class="bg-white py-6 px-4 sm:p-6">
                                        <div>
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">Update your billing information. Please
                                                note that updating your location could affect your tax rates.</p>
                                        </div>
                                        ...
                                        <div class="mt-6 grid grid-cols-4 gap-6">
                                            ...
                                            <div class="col-span-4 sm:col-span-1">
                                                <label for="expiration-date"
                                                    class="block text-sm font-medium text-gray-700">Expration date</label>
                                                    ...
                                                    <tbody class="divide-y divide-gray-200 bg-white">
                                                        <tr>
                                                            ...
                                                            <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">
                                                                Business Plan - Annual Billing</td>
                                                            <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">
                                                                CA$109.00</td>
                                                            <td
