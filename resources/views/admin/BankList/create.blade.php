...
@section("content")
    <div class="px-0 md:px-12 lg:px-24">
        <form class="space-y-6 bg-white p-3 rounded-md" action="{{ url('/admin/bank-list/create') }}" method="post">
            <h1 class="text-black font-bold text-4xl mb-4">Create Bank</h1>
            @csrf
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    <input name="name" type="text" placeholder="Bank Name" class="block border border-gray-200 rounded pr-20 pl-3 py-2 leading-6 w-full focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="tk-form-input-groups-append-text-addon-normal" />
                    <div class="absolute inset-y-0 right-0 w-16 my-px mr-px flex items-center justify-center pointer-events-none rounded-r text-gray-500 bg-gray-100 border-l border-gray-200">
                        Text
                    </div>
                </div>
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    <input name="minWithdraw" type="number" placeholder="Minimum Withdraw" class="block border border-gray-200 rounded pr-20 pl-3 py-2 leading-6 w-full focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="tk-form-input-groups-append-text-addon-normal" />
                    <div class="absolute inset-y-0 right-0 w-16 my-px mr-px flex items-center justify-center pointer-events-none rounded-r text-gray-500 bg-gray-100 border-l border-gray-200">
                        Int
                    </div>
                </div>
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    <input name="maxWithdraw" type="number" placeholder="Maximum Withdraw" class="block border border-gray-200 rounded pr-20 pl-3 py-2 leading-6 w-full focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="tk-form-input-groups-append-text-addon-normal" />
                    <div class="absolute inset-y-0 right-0 w-16 my-px mr-px flex items-center justify-center pointer-events-none rounded-r text-gray-500 bg-gray-100 border-l border-gray-200">
                        Int
                    </div>
                </div>
